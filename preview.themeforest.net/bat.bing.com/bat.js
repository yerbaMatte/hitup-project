function UET(o) {
    ...
    this.loadConfig = function() {
        ...
        f = "https:";
        this.uetConfig.batDebug = this.getQueryParam(window.location.href, "bat_debug");
        e = 0;
        ...
        this.stringExists(o.ti) && (n = document.createElement("script"), l = f + "//" + this.domain + "/p/action/" + o.ti + ".js", this.stringExists(this.uetConfig.batDebug) && (l += "?bat_debug=" + this.uetConfig.batDebug), n.src = l, n.type = "text/javascript", n.async = 1, t && n.setAttribute("data-ueto", t), document.head.appendChild(n));
        navigator.userAgentData && navigator.userAgentData.getHighEntropyValues && navigator.userAgentData.platform === "Windows" && (this.deferLoad = !0, i = this, a = setTimeout(function() {
            i.deferLoad = !1;
