...
(function() {
    ...
    */
    ...
    ch.Cf = Number("0") || 0;
    ch.ma = "dataLayer";
    ch.Ai = "ChAIgNWRnAYQkbbxyYi+lZQlEiQA7m6d6hTce5WenhH38M2gx5W0BskOvIXPUhdSot2KbgKtxfAaAqNu";
    var fh = {
            __cl: !0,
            __ecl: !0,
            __ehl: !0,
    ...
    var Yk = ["L", "S", "Y"],
        ...
        al = 0 <= G.location.search.indexOf("?gtm_latency=") || 0 <= G.location.search.indexOf("&gtm_latency="),
        bl;
    if (!(bl = al)) {
        var cl = Math.random(),
            dl = $k.sampleRate;
    ...
    var el = bl,
        fl = "https://www.googletagmanager.com/a?id=" + Ve.N + "&cv=27",
        gl = {
    ...
    function am(a) {
        ...
        if (void 0 !== Nl && (!kl[Nl] || ll || ml || bm(a)))
            if (void 0 === cm[Nl] && (Pl[Nl] || Sl.hk() || 0 >= Tl--)) R(1), Pl[Nl] = !0;
            else {
                void 0 === cm[Nl] && Sl.Fk();
                var b = Vl(!0, a);
                a ? kc(b) : dc(b);
    ...
    function Qn(a, b, c, d, e) {
        ...
        if ((void 0 == An.enable_gbraid_cookie_write ? 0 : An.enable_gbraid_cookie_write) && !l && a.gb) {
            var q = a.gb[0],
                ...
                u = !1;
            if (!b)
                for (var t = In(r), v = 0; v < t.length; v++) t[v].la === q && t[v].labels && 0 < t[v].labels.length && (u = !0);
            u || f("gb", p(q))
        }
    }
    var Un = function(a, b) {
                ...
                for (var e = {
                    ...
                    vo[g.id] ||
                        (g && "AW" === g.prefix && !e.adData && 2 <= g.M.length ? (e.adData = {
                            ak: g.M[0],
                            cl: g.M[1]
                        }, vo[g.id] = !0) : g && "UA" === g.prefix && !e.gaData && (e.gaData = {
                            gaWpid: g.V
                        }, vo[g.id] = !0))
    ...
    var Ko = function(a) {
        ...
        Uo = function(a) {
            var b = Lo("gacgb");
            return b ? !tj(Mo) && a ? "0" : decodeURIComponent(b) : Ko(Gn() ? Cn("_gac_gb", !0) : {})
        },
        Vo = function(a) {
            var b = Pn(),
                c = [],
    ...
    function Fp(a, b, c) {
        if (yp.test(G.location.host)) {
            ...
            if (d && 2 == d.length && d[1].match(xp)) return [{
                la: d[1]
            }]
    ...
    var Kp = function() {
        ...
        Np = function(a) {
            if (Lp(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"])) {
                var b = a.C[S.g.lb],
                    c = !0 === T(a.s, S.g.Ud);
        ...
        pq = function(a) {
            Lp(a, ["conversion"]) && a.s.eventMetadata.is_external_event && (a.C[S.g.Bh] = !0)
        },
        qq = function(a) {
            var b;
    ...
    var Vq = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/),
        Wq = {
            cl: ["ecl"],
    ...
    Bs.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.h.length;) {
            var f = this.h[0];
            if (f.messageContext.deferrable) !f.da || Cs(this, f.da).D ? (f.messageContext.deferrable = !1, this.h.push(f)) : c.push(f), this.h.shift();
            else {
                var g = void 0;
                switch (f.type) {
                    case "require":
    ...
    var Es = function(a, b) {
            if ("require" !== b.type)
                if (b.da)
                    for (var c = Cs(a, b.da).B[b.type] || [], d = 0; d < c.length; d++) c[d]();
                else
                    for (var e in a.B)
                ...
                if (!(2 > a.length) && k(c)) {
                    ...
                    if (k(r) || Ea(r)) {
                        var u = r.toString().replace(/\s+/g, "").split(","),
                            ...
                            w = t.uk;
                        if (w.length)
                            for (var y = q && q[S.g.wa] || ws.D[S.g.wa], x = 0; x < w.length; x++) {
                                var A = ko(w[x]);
                                A && Uq(A.V, y, {
                                    source: 3,
                                    fromContainerExecution: b.fromContainerExecution
    ...
    var gA = window,
        ...
        iA = function(a) {
            ...
            for (var d = zj("AMP_TOKEN", String(hA.cookie), !0), e = 0; e < d.length; e++)
    ...
    (function(a) {
        ...
        if (Ve.Xb ? dh["ctid_" + Ve.Xb] : dh[Ve.N]) {
            ...
            RC(v);
            if (void 0 !== w)
                for (var P = 0; P < w.length; P++) xh[w[P]] = !0;
            nE();
            bu();
            ir = !1;
            jr = 0;
            if ("interactive" == G.readyState && !G.createEventObject || "complete" == G.readyState) lr();
            else {
